<script>
	...
	import DataList 		from './Example/DataList.svelte'

	import GlobalSearch 	from './Example/GlobalSearch.svelte'
	import Filters 			from './Example/Filters.svelte'
	import Sort 			from './Example/Sort.svelte'
	import ItemCount 		from './Example/ItemCount.svelte'
	import Pagination 		from './Example/Pagination.svelte'
