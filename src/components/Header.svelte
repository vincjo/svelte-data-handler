...
<style>
	header {font-weight:300;padding:0;height:40px;position:fixed;top:0;right:0;z-index:200;}  
	header a {text-decoration: none;padding:0;display: block;font-size:16px;line-height:40px;}
	div{display:flex;margin-right:16px;float:right;}
	svg{float:left;padding:8px 8px;width:40px;height:40px;}
</style>