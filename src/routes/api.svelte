...
<section>
    ...
    <aside>
        <div>
            ...
            <p>Return the data as a readable store that can dynamically renders sorted, filtered and paginated objects.</p>
        </div>
        <article class="code">
    ...
    <aside>
        <div>
            ...
            <p>Return an object containing the total number of items, a start-index and an end-index of items that are displayed into the current page. Each time a filter is applied on data, these numbers will automatically update.</p>
        </div>
        <article class="code">
    ...
    <aside>
        <div>
            ...
            <p>Sort data in ascending order using 1 object key.</p>
    ...
    <aside>
        <div>
            ...
            <p>Sort data in descending order using 1 object key.</p>
    ...
    <aside>
        <div>
            ...
            <p>Update $items store with a set of objects matching with the search value.</p>
            <h3>clearSearch()<span>: void</span></h3>
            <p>Programmatically remove the global search.</p>
        </div>
        <article class="code">
    ...
    <aside>
        <div>
            ...
            <p>Programmatically remove all filters</p>
        </div>
        <article class="code">
    ...
    <aside>
        <div>
            <h3>updateParams(<span><b>params</b>: {`{ itemsPerPage: number | null }`}</span>)<span>: void</span></h3>
            <p>Update "itemsPerPage" setting. Item pagination can be adjusted at any time.</p>
        </div>
        <article class="code">
            <HighlightSvelte language={typescript} code={updateParams}/>
        </article>
    </aside>
...
<style>
    section{max-width:1160px;padding-bottom:80px;}
	...
	article{border-radius:8px;padding:4px 8px;margin-right:16px;background:var(--hljs);width:560px;}
</style>